...
function initMap(){
  ...
  function e(){
    var e="SELECT 'col0', 'London Terminus', 'Season Ticket Price', 'Commute Time', 'Average House Price', 'Trains Per Day', 'Crime Levels', 'Pubs Per Capita', 'Approx Population',  'Commuter Town Score' FROM 1lMyWyrSb6GyJWaZS8_oouid-YVs9vGEXs7-pKJud  ORDER BY 'Commuter Town Score' DESC LIMIT 10",
    o=encodeURIComponent(e),
    a=new google.visualization.Query("https://www.google.com/fusiontables/gvizdata?tq="+o),
    t= {
      headerRow:"fusionTableRowHeader",
      tableRow:"fusionTableTableRows",
      oddTableRow:"fusionTableTableRows"
    };
    a.send(function(e){
      var o=new google.visualization.Table(document.getElementById("visualization")),
      a=e.getDataTable(),
      i=new google.visualization.NumberFormat({
        prefix:"£",negativeColor:"red",negativeParens:!0,fractionDigits:0
      });
      i.format(a,2),i.format(a,4);
      var s=new google.visualization.NumberFormat({
        suffix:" mins (fastest)",negativeColor:"red",negativeParens:!0,fractionDigits:0
      });
      s.format(a,3);
      var n=new google.visualization.NumberFormat({
        suffix:" out of 10",negativeColor:"red",negativeParens:!0,fractionDigits:2
      });
      n.format(a,9),o.draw(a,{
        showRowNumber:!1,cssClassNames:t
      })
    })
  }
  ...
  a=new google.maps.FusionTablesLayer({
    query:{
      select:"'col0'",
  ...
  a.setMap(o),google.load("visualization","1",
  {
    packages:["table"],
    callback:e
  }),
  ...
  google.maps.event.addListener(a,"click",function(e){
    $(window).width()>1199&&o.panBy(300,100)
  })
}

function updateMap(e){
  !function(){
    var e="£"+$("#housePrice").val().toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),
    o="£"+$("#seasonTicket").val().toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),
          ...
          0==$(".google-visualization-table-td").length&&$("#personalised-results").css("display","none")}
            function l(){
              ...
              c.send(function(e){
                var o=new google.visualization.Table(document.getElementById("visualization")),
                a=e.getDataTable(),
                t=new google.visualization.NumberFormat({
                  prefix:"£",
                  negativeColor:"red",
                  negativeParens:!0,
                  fractionDigits:0
                ...
                t.format(a,2),
                t.format(a,4);
                var i=new google.visualization.NumberFormat({
                  suffix:" mins (fastest)",
                  negativeColor:"red",
                  negativeParens:!0,
                  fractionDigits:0
